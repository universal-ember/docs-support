...
export const IndexPage: TOC<{
  ...
  <Hero class='shadow-xl shadow-slate-900/5 gradient-background'>
    <header
      class='absolute md:sticky right-0 bottom-0 md:top-0 z-50 p-4 flex items-center'
    >
      {{yield to='header'}}
    </header>
  ...
  <hr />
  <footer
    style='padding: 3rem; width: 66%;'
    class='mx-auto gap-12 flex-wrap flex justify-between'
  >
    {{yield to='footer'}}
  </footer>
</template>;
